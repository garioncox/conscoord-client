...
import {
  useGEmailInput,
  validateEmail,
} from "../Components/Generics/control/gEmailInputController";
import {
  useGPhoneInput,
  validatePhone,
} from "../Components/Generics/control/gPhoneInputController";
...
function AddOfficer() {
  ...
  return (
    <>
      <tr>
        <td>
          <GTextInput control={nameControl} />
        </td>
        <td>
          <GPhoneInput control={phoneControl} />
        </td>
        <td>
          <GEmailInput control={emailControl} />
        </td>
        <td></td>
        <td>
          <button className="btn btn-primary" onClick={AddOfficer}>
            Add Employee
          </button>
        </td>
      </tr>
