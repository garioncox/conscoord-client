        ...
        <div className="space-y-4">
          {Editing ? (
            ...
            [
              ...
              { label: 'Email', value: EmployeeEmail, setter: setEmployeeEmail },
              { label: 'Phone Number', value: EmployeePhoneNumber, setter: setEmployeePhoneNumber },
              { label: 'Role ID', value: EmployeeRoleId, setter: (e) => setEmployeeRoleId(parseInt(e.target.value)) },
              { label: 'Company ID', value: EmployeeCompanyId, setter: (e) => setEmployeeCompanyId(parseInt(e.target.value)) }
            ].map((field, index) => (
              <div key={index}>
